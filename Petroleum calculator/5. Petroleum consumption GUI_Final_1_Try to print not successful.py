...
#Παίρνω την τελευταια στάθμιση percentWHours και την πολλαπλασιάζω με το συνολκό ποσό που κατανάλωσαν έως τώρα όλοι οι ένοικοι για να βρούμε τι
#κατανάλωσε το κάθε διαμέρισμα εκφρασμένο σε €
...
#Try to print
def export():
    exp = open('report.txt', 'w')
    exp.write(moneyApart1.get())
    exp.close()
    exp = open('report.txt', 'r')
    print(exp.read())
...
export=Button(window, text='Print', font='calibri 16', command=export())
export.place(x=700, y=400)
