...
def consumption():   
    ...
    text_file.write('1st apartment ' + '\n')
    text_file.write('Heating calories: ')
    text_file.write(heatingCalories1.get() + '\n')
    text_file.write('1st measurment: ')
    text_file.write(firstMeasurment1.get() + '\n')
    text_file.write('2nd measurment: ')
    text_file.write(secondMeasurment1.get() + '\n')
    text_file.write('Counter working hours: ')
    text_file.write(counterConsumption1.get() + '\n')
    text_file.write('Consumption liters: ')
...
#Calculation button
calc=Button(window, text='Calculate \n & save', font='calibri 18', command=lambda:consumption())
