...
label_1 = Label(window, font='calibri 10', text = "Λίτρα στη δεξαμενή")
label_1.grid(row = 6, column = 0, sticky = W, pady = 2)
label_2 = Label(window, font='calibri 10', text = "Μετρητής 1 (ώρες)")
label_2.grid(row = 9, column = 0, sticky = W, pady = 2)
label_3 = Label(window, font='calibri 10', text = "Μετρητής 2 (ώρες)")
label_3.grid(row = 12, column = 0, sticky = W, pady = 2)
label_4 = Label(window, font='calibri 10', text = "Μετρητής 3 (ώρες)")
label_4.grid(row = 15, column = 0, sticky = W, pady = 2)
label_5 = Label(window, font='calibri 10', text = "Μετρητής 4 (ώρες)")
label_5.grid(row = 18, column = 0, sticky = W, pady = 2)
label_6 = Label(window, font='calibri 10', text = "Μετρητής 5 (ώρες)")
label_6.grid(row = 21, column = 0, sticky = W, pady = 2)                                                                                                                  
label_7 = Label(window, font='calibri 10', text = "       1η μέτρηση")
label_7.grid(row = 0, column = 3, sticky = W, pady = 2)
label_8 = Label(window, font='calibri 10', text = "       2η μέτρηση")
label_8.grid(row = 0, column = 6, sticky = W, pady = 2)
label_9 = Label(window, font='calibri 10', text = "         Κατανάλωση")
label_9.grid(row = 0, column = 9, sticky = W, pady = 2)
label_12 = Label(window, font='calibri 10', text = "    Λίτρα/διαμέρισμα")
label_12.grid(row = 0, column = 18, sticky = W, pady = 2)
label_13 = Label(window, font='calibri 10', text = "    Ευρώ/διαμέρισμα")
label_13.grid(row = 0, column = 21, sticky = W, pady = 2)
label_14 = Label(window, font='calibri 10', text = "    Συνολικό ποσό πετρελαίου")
label_14.place(x=0, y=400)
label_15 = Label(window, font='calibri 10', text = "    Θερμιδική αξία διαμερίσματος")
label_15.grid(row = 0, column = 27, sticky = W, pady = 2)
label_16 = Label(window, font='calibri 10', text = "    Υπόλοιπο πετρελαίου (λίτρα)")
label_16.place(x=0, y=500)
label_17 = Label(window, font='calibri 10', text = "Τιμή/λίτρο υπολειπόμενου πετρελαίου")
label_17.place(x=0, y=450)
label_18 = Label(window, font='calibri 10', text = "    Νέο πετρέλαιο (λίτρα)")
label_18.place(x=0, y=550)
label_19 = Label(window, font='calibri 10', text = "    Ευρώ νέου πετρελαίου")
label_19.place(x=0, y=600)
label_20 = Label(window, font='calibri 10', text = "    Τιμή/λίτρο για νέο πετρέλαιο")
...
#Calculation button
calc=Button(window, text='Υπολογισμός \n & αποθήκευση', font='calibri 18', command=lambda:consumption())
...
#Clear all button
clear=Button(window, text='Καθαρισμός', font='calibri 16', command=lambda:clear_all())
clear.place(x=400, y=400)


#Open file with instructions
instruct=Button(window, text='Οδηγίες συμπλήρωσης', font='calibri 16', command=lambda:instructions())
